...
def manage_students():
    # your code here
  students = ['Mikey', 'Janet', 'Jason', 'Melinda']
...
def combine_foods():
    # your code here
  foods = ['salame', 'pickles', 'noodles', 'bread']
  meal = ''
  for food in foods:
    meal += food
  return meal
...
# Using the home_town dictionary, assign to a variable named 
# home_town_message a string with this format: 
...
def hometown_info():
  ...
  home_town_message = "I was born in " + home_town['city']+ ", " + home_town['state'] + ". It has a population of" + home_town['population'] + "!"
